...
// Memory functions
ILAPI void*	ILAPIENTRY ialloc(ILuint Size);
ILAPI void	ILAPIENTRY ifree(void *Ptr);
ILAPI void*	ILAPIENTRY icalloc(ILuint Size, ILuint Num);
#ifdef ALTIVEC_GCC
ILAPI void*	ILAPIENTRY ivec_align_buffer(void *buffer, ILuint size);
#endif
