...
### Hakkında ###
Metin2 Sıfırdan Altyapı Server Files Hazırlama Rehberini hazırlarken kullandığım dosyaların 2025 yılında güncellenmiş hali.  
...
### Nasıl Kurulur? ####
Şuan için bu dosyalar FreeBSD 14.x (32bit) ile build edilmektedir.
...
> tar -zxf Extern-server-freebsd-14-i386.tgz
